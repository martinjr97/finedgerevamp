...
@if ($compact)
    @if($financialInstitutions->isEmpty())
        <div class="rounded-2xl border border-amber-400/30 bg-amber-500/10 p-4 text-sm text-amber-100 mb-4">
            No financial institutions yet.
            <a href="{{ route('admin.financial-institutions.create') }}" class="underline hover:text-amber-50">Add an institution</a>
            before creating a bank account.
        </div>
    @endif
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        @include('partials.admin.bank-account-digits-field', [
            'bank' => $bank,
            'inputId' => 'bank_account_digits',
            'showHelp' => true,
        ])

        <div>
            <label class="text-sm font-medium text-slate-300" for="bank_account_name">
                Account holder name <span class="text-rose-400">*</span>
            </label>
            <input type="text"
        ...
        <div>
            <label class="text-sm font-medium text-slate-300" for="bank_financial_institution">
                Bank <span class="text-rose-400">*</span>
            </label>
        ...
        <div>
            <label class="text-sm font-medium text-slate-300">
                Opening balance (ZMW) <span class="text-rose-400">*</span>
            </label>
            <input type="number"
...
@else
    ...
    <div class="space-y-4 pt-4 border-t border-white/10" data-bank-institution-fields>
    ...
    <div class="space-y-4 pt-4 border-t border-white/10">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                <label class="text-sm font-medium text-slate-300">
                    Opening balance <span class="text-rose-400">*</span>
                </label>
                <input type="number"
                       name="opening_balance"
                       value="{{ old('opening_balance', $bank?->opening_balance ?? 0) }}"
