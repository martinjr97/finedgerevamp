...
<div class="rounded-3xl {{ $sectionClass }} p-6 shadow-lg">
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="text" name="next_of_kin_phone" value="{{ old('next_of_kin_phone', optional($customer)->next_of_kin_phone) }}" maxlength="12" inputmode="numeric" pattern="260[0-9]{9}" class="mt-2 w-full rounded-2xl {{ $inputClass }} text-white px-4 py-3 {{ $inputFocusClass }} zambian-phone-input" placeholder="260970000000" required>
