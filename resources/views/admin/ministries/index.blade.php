                    ...
                    <tbody>
                        @forelse ($ministries as $ministry)
                            <tr class="border-t border-white/40 text-center hover:bg-white/5 transition">
                                <td class="px-4 py-4 font-medium text-white border-r border-white/5">{{ $ministry->name }}</td>
                                <td class="px-4 py-4 border-r border-white/5">{{ $ministry->code }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-4 py-8 text-center text-slate-400">No ministries found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
