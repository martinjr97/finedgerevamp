    ...
    <div class="space-y-8">
        @include('partials.admin.page-header', [
            ...
            'buttons' => [
                ...
                [
                    'action' => 'default',
                    'text' => 'Due Last 14 Days',
                    'href' => route('admin.loans.missed-payments'),
                    'icon' => '<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
                    'can' => auth('admin')->user()?->can('loans.view')
                ]
            ]
        ])
