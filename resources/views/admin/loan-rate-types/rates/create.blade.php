...
@section('title', 'Add Loan Rate | '.config('app.system_name'))
...
@section('content')
    <div class="space-y-8">
        ...
        <form action="{{ route('admin.loan-rate-types.rates.store', $loanRateType) }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="rounded-3xl {{ $sectionClass }} p-6 shadow-lg">
                ...
                @include('admin.loan-rate-types.rates.partials.fields', ['loanRate' => null])
            </div>
