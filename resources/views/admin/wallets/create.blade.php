        ...
        <form action="{{ route('admin.wallets.store') }}" method="POST" class="space-y-6">
            ...
            <div class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="wallet_number" value="{{ old('wallet_number') }}" required maxlength="100" placeholder="e.g., 56654651 or 543-1223234M" class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
