                ...
                <table data-datatable="true" data-datatable-per-page="10" class="min-w-full w-full text-base text-slate-300">
                    <thead>
                        <tr class="text-base font-semibold uppercase tracking-[0.25em] text-white/80 text-center border-b-2 border-white/20">
                            ...
                            <th class="px-4 py-4 text-lg border-r border-white/10">Wallet Number</th>
                            <th class="px-4 py-4 text-lg border-r border-white/10">Provider</th>
                    ...
                    <tbody>
                        @forelse ($wallets as $wallet)
                            <tr class="border-t border-white/40 text-center hover:bg-white/5 transition">
                                <td class="px-4 py-4 font-medium text-white border-r border-white/5">{{ $wallet->name }}</td>
                                <td class="px-4 py-4 border-r border-white/5">{{ $wallet->wallet_number }}</td>
                                <td class="px-4 py-4 capitalize border-r border-white/5">{{ $wallet->provider }}</td>
                                <td class="px-4 py-4 border-r border-white/5">{{ $wallet->currency }}</td>
                                <td class="px-4 py-4 font-semibold border-r border-white/5 {{ $wallet->current_balance >= 0 ? 'text-emerald-400' : 'text-rose-400' }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-4 py-8 text-center text-slate-400">No wallets found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
