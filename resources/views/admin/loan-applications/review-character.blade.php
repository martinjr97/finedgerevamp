...
@section('content')
    <div class="space-y-8">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            {{-- Group Configuration --}}
            <div class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg space-y-4">
                <h2 class="text-lg font-semibold text-white mb-2">Group Configuration</h2>
                @if($customerGroup)
                    <div class="space-y-3 text-sm text-slate-200">
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                <p class="text-xs uppercase tracking-wide text-slate-400 mb-1">Loan Payment Date</p>
                                <p class="text-base font-semibold text-white">
        ...
        <div class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg space-y-6">
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <form method="POST" action="{{ route('admin.loan-applications.store-character', [$loanProduct, $customer]) }}">
                    @csrf
                    <button type="submit"
                            class="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 px-4 py-3 text-base font-semibold text-white shadow-lg shadow-amber-500/30 hover:from-amber-600 hover:to-amber-700 transition">
                        Confirm & Create Loan
                    </button>
                </form>
            </div>
