<form action="{{ route('admin.customers.update', $customer) }}" method="POST" class="space-y-8">
    ...
    <div class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="first_name" value="{{ old('first_name', $customer->first_name) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <input type="text" name="last_name" value="{{ old('last_name', $customer->last_name) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
    ...
    <div class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div class="md:col-span-2">
                ...
                <input type="text" name="address_line1" value="{{ old('address_line1', $customer->address_line1) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="address_line2" value="{{ old('address_line2', $customer->address_line2) }}" class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <input type="text" name="city" value="{{ old('city', $customer->city) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <select name="province_id" class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
                    ...
                    @foreach ($provinces as $province)
                        <option value="{{ $province->id }}" @selected(old('province_id', $customer->province_id) == $province->id)>{{ $province->name }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="postal_code" value="{{ old('postal_code', $customer->postal_code) }}" class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <input type="text" name="country" value="{{ old('country', $customer->country ?? 'Zambia') }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
    ...
    @php
        $savedOccupationType = data_get($customer->metadata, 'group_loans_occupation_type');
        if (! $savedOccupationType) {
            $savedOccupationType = $customer->employment_status === 'self_employed' ? 'business_owner' : ($customer->employment_status === 'employed' ? 'employed' : null);
        }
    @endphp
    <div class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-lg">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div>
                ...
                <select name="occupation_type" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
                    ...
                    <option value="employed" @selected(old('occupation_type', $savedOccupationType) === 'employed')>Employed</option>
                    <option value="business_owner" @selected(old('occupation_type', $savedOccupationType) === 'business_owner')>Business Owner</option>
                </select>
            ...
            <div>
                ...
                <input type="text" name="employer_or_business_name" value="{{ old('employer_or_business_name', data_get($customer->metadata, 'group_loans_employer_or_business_name')) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <input type="number" name="average_income" value="{{ old('average_income', $customer->net_salary) }}" step="0.01" min="0" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40" placeholder="0.00">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="work_address_line1" value="{{ old('work_address_line1', $customer->work_address_line1) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="work_address_line2" value="{{ old('work_address_line2', $customer->work_address_line2) }}" class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <input type="text" name="work_city" value="{{ old('work_city', $customer->work_city) }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                >
                    <option value="">Select Province</option>
                    @foreach ($provinces as $province)
                        <option value="{{ $province->id }}" @selected(old('work_province_id', $customer->work_province_id) == $province->id)>{{ $province->name }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                >
                    ...
                    @foreach ($districts as $district)
                        <option value="{{ $district->id }}" data-province-id="{{ $district->province_id }}" @selected(old('work_district_id', $customer->work_district_id) == $district->id)>{{ $district->name }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="work_postal_code" value="{{ old('work_postal_code', $customer->work_postal_code) }}" class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
            ...
            <div>
                ...
                <input type="text" name="work_country" value="{{ old('work_country', $customer->work_country ?? 'Zambia') }}" required class="mt-2 w-full rounded-2xl bg-white/10 border border-white/10 text-white px-4 py-3 focus:border-cyan-400 focus:ring-cyan-400/40">
