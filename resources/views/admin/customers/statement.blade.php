    ...
    <div class="space-y-8">
        @include('partials.admin.page-header', [
            ...
            'buttons' => [
                ...
                [
                    'text' => 'Download PDF',
                    'href' => route('admin.customers.statement.pdf', array_merge([$customer], request()->only(['from_date', 'to_date', 'loan_id']))),
                    ...
                    'class' => 'inline-flex items-center gap-2 rounded-xl border border-cyan-400/40 bg-cyan-500/10 px-3 py-2 text-sm font-semibold text-cyan-100 hover:bg-cyan-500/20 transition',
                ],
                [
                    'text' => 'Print',
