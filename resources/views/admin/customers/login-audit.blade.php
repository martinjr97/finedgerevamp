    ...
    <div class="space-y-8">
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_auto] lg:items-center">
            <div class="space-y-1 text-left">
                ...
                <h1 class="text-3xl font-bold">Login Audit - {{ $customer->full_name }}</h1>
                <p class="text-sm text-slate-400 mt-2">View all login attempts for this customer</p>
            </div>
        ...
        <div class="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 shadow-lg">
            <form method="GET" action="{{ route('admin.customers.login-audit', $customer) }}" class="grid gap-4 md:grid-cols-4">
                <div>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('admin.customers.login-audit', $customer) }}" class="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/5 px-4 py-2.5 text-sm font-medium text-slate-300 hover:bg-white/10 transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr>
                                <td colspan="6" class="px-4 py-12 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-sm text-slate-500">This customer has no recorded login attempts yet.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
